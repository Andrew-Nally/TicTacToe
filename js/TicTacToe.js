...
function rollForTurn() {
  ...
  txt1 = "Player 1 rolled [" + pOne + "]<br> Player 2 rolled [" + pTwo + "]<br><br>";
  setTimeout(function() {
    writeMsg(txt1);
  }, 1000);
  ...
  if (pOne > pTwo) {
    first = "Player 1";
    setTimeout(function() {
     txt1 = txt1 + "Player 1 wins, please select a square.";
    }, 2000);
    setTimeout(function() {
      writeMsg(txt1);
    }, 2000);
    ...
    first = "Player 2";
    setTimeout(function() {
      txt1 = txt1 + "Player 2 wins, please select a square.";
    }, 2000);
    setTimeout(function() {
      writeMsg(txt1);
    }, 2000);
...
function saveSettings() {
  ...
  if (p1Selected[p1Index].text == p2Selected[p2Index].text) {
    alert(
      "Player 1 & Player 2 cannot both be " +
        p1Selected[p1Index].text +
        ". Configuration has not been applied or saved."
    );
    document.getElementById("player1").selectedIndex = document.getElementById(
      "p1Display"
    ).innerHTML;
    document.getElementById("player2").selectedIndex = document.getElementById(
      "p2Display"
    ).innerHTML;
  } else {
...
function avatarPlaced() {
  ...
  if (
    parseText == "That's three in a row, Player 1 wins!" ||
    parseText == "That's three in a row, Player 2 wins!"
  ) {
    showPlayer.innerHTML = "Game Stopped";
    showPlayer.style.color = "red";
  }
...
function check4Tie() {
  ...
  if (
    boardState.length >= 9 &&
    check != "That's three in a row, Player 1 wins!" &&
...
function glowBoard(pos) {
  ...
  for (var i = 0; i < squares.length; i++) {
    if (i == index0) {
      ...
      winSound();
      setTimeout(function() {
        bg1.style.backgroundColor = "rgb(244, 179, 66)";
      }, 100);
      setTimeout(function() {
        bg1.style.backgroundColor = "rgb(244, 238, 66)";
      }, 200);
      setTimeout(function() {
        bg1.style.backgroundColor = "rgb(197, 244, 66)";
      }, 300);
      setTimeout(function() {
        bg1.style.backgroundColor = "rgb(122, 244, 66)";
      }, 400);
      setTimeout(function() {
        bg1.style.backgroundColor = "rgb(66, 244, 235)";
      }, 500);
      setTimeout(function() {
        bg1.style.backgroundColor = "rgb(244, 179, 66)";
      }, 600);
      ...
      setTimeout(function() {
        bg1.style.backgroundColor = "#d7f3f7";
      }, 1100);
    } else if (i == index1) {
      var bg2 = squares[i];
      setTimeout(function() {
        bg2.style.backgroundColor = "rgb(66, 244, 235)";
      }, 100);
      setTimeout(function() {
        bg2.style.backgroundColor = "rgb(122, 244, 66)";
      }, 200);
      setTimeout(function() {
        bg2.style.backgroundColor = "rgb(197, 244, 66)";
      }, 300);
      setTimeout(function() {
        bg2.style.backgroundColor = "rgb(244, 238, 66)";
      }, 400);
      setTimeout(function() {
        bg2.style.backgroundColor = "rgb(244, 179, 66)";
      }, 500);
      setTimeout(function() {
        bg2.style.backgroundColor = "rgb(66, 244, 235)";
      }, 600);
      ...
      setTimeout(function() {
        bg2.style.backgroundColor = "#d7f3f7";
      }, 1100);
    } else if (i == index2) {
      var bg3 = squares[i];
      setTimeout(function() {
        bg3.style.backgroundColor = "rgb(244, 179, 66)";
      }, 100);
      setTimeout(function() {
        bg3.style.backgroundColor = "rgb(244, 238, 66)";
      }, 200);
      setTimeout(function() {
        bg3.style.backgroundColor = "rgb(197, 244, 66)";
      }, 300);
      setTimeout(function() {
        bg3.style.backgroundColor = "rgb(122, 244, 66)";
      }, 400);
      setTimeout(function() {
        bg3.style.backgroundColor = "rgb(66, 244, 235)";
      }, 500);
      setTimeout(function() {
        bg3.style.backgroundColor = "rgb(244, 179, 66)";
      }, 600);
      ...
      setTimeout(function() {
        bg3.style.backgroundColor = "#d7f3f7";
      }, 1100);
    }
  }
  setTimeout(function() {
...
function blink() {
  ...
  setTimeout(function() {
    body.style.backgroundColor = "#94f7ed";
  }, 100);
  setTimeout(function() {
    body.style.backgroundColor = "#94cef7";
  }, 200);
  setTimeout(function() {
    body.style.backgroundColor = "#94a6f7";
  }, 300);
  setTimeout(function() {
    body.style.backgroundColor = "#b094f7";
  }, 400);
  setTimeout(function() {
    body.style.backgroundColor = "#cc94f7";
  }, 500);
  setTimeout(function() {
    body.style.backgroundColor = "#e894f7";
  }, 600);
  setTimeout(function() {
    body.style.backgroundColor = "#f794d9";
  }, 700);
  setTimeout(function() {
    body.style.backgroundColor = "#f73881";
  }, 800);
  setTimeout(function() {
    body.style.backgroundColor = "#c6034e";
  }, 900);
  setTimeout(function() {
    body.style.backgroundColor = "#e00202";
  }, 1000);
  setTimeout(function() {
...
function animateO(selected) {
  selected.style.transform =
    selected.style.transform == "translateY(-100%)" || null
      ? "translateY(0)"
      : "translateY(-100%)";
}
...
function checkForEachWinningCondition(info, squareArray) {
  ...
  if (
    match0Avatar != undefined &&
    match1Avatar != undefined &&
    match2Avatar != undefined
  ) {
